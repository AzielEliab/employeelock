...
function openapiSpec(origin) {
  return {
    ...
    info: {
      ...
      description: LIMITATION + " Suite mesh /v1/mesh/* PROXY to aziel-runtime (AZIEL_RUNTIME). Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 photon QNS1 packet transfer cross-map (hub cite only; not Softwares-tab; no public qnsd proxy). No Node Gate. No auto-heal. Not anonymity. Aziel Eliab only.",
...
<p>Suite mesh: <code>GET ${origin}/v1/mesh</code> PROXY to aziel-runtime. Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 photon QNS1 packet transfer cross-map (hub cite / Worker mesh only; not Softwares-tab; no public qnsd proxy). No Node Gate. No auto-heal. Not anonymity. Author: Aziel Eliab only.</p>
